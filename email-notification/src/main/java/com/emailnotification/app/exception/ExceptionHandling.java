...
import com.emailnotification.app.exception.domain.CustomCouldNotDeleteException;
import com.emailnotification.app.exception.domain.CustomNotFoundException;
import com.emailnotification.app.exception.domain.JwtTokenNotValidException;
...
public class ExceptionHandling {
    ...
    public ResponseEntity<HttpResponseException> customCouldNotValidateTokenException(JwtTokenNotValidException jwtTokenNotValidException) {
        ...
        return createHttpResponse(HttpStatus.BAD_REQUEST, jwtTokenNotValidException.getMessage(), 107);
    }
